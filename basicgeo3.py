...
class TestContext (BaseContext):
	...
	Shows use of uniforms, and a few simle calculations within the vertex shader..."""
	...
	def OnInit(self):
		vertex = shaders.compileShader("""
			...
			float fog_coord; //distance for fog calc
			//this function is generally faster annd guaranteed
		...
		self.shaders = shaders.compileProgram(vertex,fragment)
		self.vbo = vbo.VBO(
			array([
                [  0, 1, 0,  0,1,0 ],
                [ -1,-1, 0,  1,1,0 ],
		...
		'end_fog':glGetUniformLocation(self.shaders,'end_fog'),
		'fog_color':glGetUniformLocation(self.shaders,'fog_color'),
		}
